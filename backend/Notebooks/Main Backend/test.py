...
try:
    ...
    with open('E:/VS Code Programs/Projects/Web Dev Projects/BotMed/backend/Notebooks/Main Backend/whisper_aud_text.ipynb', 'r', encoding='utf-8') as f:
    ...
    try:
        with open('E:/VS Code Programs/Projects/Web Dev Projects/BotMed/backend/Notebooks/Main Backend/whisper_aud_text.ipynb', 'r', encoding='utf-8', errors='ignore') as f:
            data = json.load(f)
